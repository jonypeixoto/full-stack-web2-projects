<h1 align="center">
    <img alt="Front-End GitHub README" src="https://github.com/jonypeixoto/jonypeixoto/blob/main/assets/Dynamic-Site-HTML5-And-Marking.gif" />
    <br>
    Dynamic Site HTML5 and Marking - Basic Website
</h1>

<h4 align="center">
  Dynamic Site HTML5 and Marking - Basic Websitep is a repository of the project involving web 2.0 and front-end that every programmer in the world should know:
...
![App Screenshot](https://github.com/jonypeixoto/jonypeixoto/blob/main/assets/GIF-Dynamic-Site-HTML5-And-Marking.gif)<br/>
