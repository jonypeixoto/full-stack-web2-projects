<h1 align="center">
    <img alt="Full-Stack GitHub README" src="https://github.com/jonypeixoto/jonypeixoto/blob/main/assets/essentialaboutgraphql.gif" />
    <br>
    Essential about GraphQL
</h1>
...
It is a query language. Used in API's. It's a way for the client to specify "exactly" what he wants.
...
Rather than having multiple endpoints. We use only one endpoint where we directly request the desired information.

<br/>

An example of multiple endpoints:
<br/>
cybertimeup.com/carros/1
cybertimeup.com/carros/2
...
The same GraphQL applications can be done with REST API.
