...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 01, 2023 at 06:00 PM
...
(1, 'Jony', 'jonypeixotooriginal@gmail.com', '909090');
...
(1, 'Jony', 'jony_peixoto1@hotmail.com', 'Admin', '09888181', ''),
(2, 'Joao', 'joao@hotmail.com', 'funcionario', '090909090', '');

-- --------------------------------------------------------

--
-- Table structure for table `tb_admin.contatos`
--
...
--
-- Dumping data for table `tb_admin.contatos`
--

INSERT INTO `tb_admin.contatos` (`id`, `email`, `lista_id`) VALUES
(2, 'contato@cybertimeup.com', 4),
(3, 'testes@cybertimeup.com', 4);
...
--
-- Table structure for table `tb_admin.listas_email`
--
...
--
-- Dumping data for table `tb_admin.listas_email`
--
...
(1, 'admin', 'admin', '64f124e1d1e3f.jpg', 'Jonathan P. Peixoto', 2),
(2, 'jonyjony768', '123456', 'cybertimeup_bg.jpg', 'Jonathan P. Peixoto', 0),
...
(4, 'Jonathan P. Peixoto', 'contato@cybertimeup.com', '909090', '5a00b2f19bae6.jpg'),
(5, 'Fernando Flach', 'fernando@cybertimeup.com', '909090', '5a00b2fd66863.jpg'),
(6, 'Giusepe Fontanela', 'giu@cybertimeup.com', '909090', '5a00b309f1c84.jpg');
...
--
-- Indexes for table `tb_admin.contatos`
--
...
--
-- Indexes for table `tb_admin.listas_email`
--
...
--
-- AUTO_INCREMENT for table `tb_admin.contatos`
--
ALTER TABLE `tb_admin.contatos`
...
--
-- AUTO_INCREMENT for table `tb_admin.listas_email`
--
ALTER TABLE `tb_admin.listas_email`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
