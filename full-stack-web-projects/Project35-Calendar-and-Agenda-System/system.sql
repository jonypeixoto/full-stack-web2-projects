...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 13, 2023 at 11:39 PM
...
INSERT INTO `tb_admin.agenda` (`id`, `task`, `data`) VALUES
(1, 'Feed Thor', '2023-08-13'),
(2, 'Go to the gym', '2023-08-13'),
(3, 'Go to the doctor', '2023-08-14'),
(4, 'Other task', '2023-08-13'),
(5, 'My task 02', '2023-08-14'),
(6, 'My task to the day 14', '2023-08-14'),
(7, 'Ok', '2023-08-14'),
(8, 'Other task 03', '2023-08-16'),
(9, 'Testing date now', '2023-08-14'),
(10, 'My task 04', '2023-08-15');
...
INSERT INTO `tb_admin.chat` (`id`, `user_id`, `message`) VALUES
(1, 1, 'Hello guys!\n'),
(2, 1, 'Hi\n'),
(3, 1, 'Hi\n'),
(4, 1, 'Hi\n'),
(5, 1, 'Hello\n'),
(6, 1, 'Ok\n'),
(7, 1, 'Hey, Jony from here!\n'),
(8, 2, 'I\'am Thayná Copim. What is your name?\n'),
(9, 1, 'Jony\n'),
(10, 1, 'Jony Peixoto\n'),
(11, 1, 'Opaaaa!\n'),
(12, 2, 'Okkkaayy\n'),
...
--
-- Table structure for table `tb_admin.enterprises`
--
...
--
-- Dumping data for table `tb_admin.enterprises`
--

INSERT INTO `tb_admin.enterprises` (`id`, `name`, `type`, `price`, `image`, `slug`, `order_id`) VALUES
(5, 'Enterprise 1', 'commercial', '', '64c4d67e78b17.jpg', 'Enterprise 1', 1),
(6, 'Enterprise 2', 'commercial', '', '64c4d68d0d175.jpg', 'Enterprise 2', 2),
(7, 'Enterprise 3', 'commercial', '', '64c4d69a3d78a.jpg', 'Enterprise 3', 3);
...
--
-- Table structure for table `tb_admin.images_properties`
--

CREATE TABLE `tb_admin.images_properties` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `tb_admin.images_properties`
--

INSERT INTO `tb_admin.images_properties` (`id`, `property_id`, `image`) VALUES
(2, 2, '64caa0e4ec918.png'),
(3, 3, '64cab2e079c9e.png'),
(4, 4, '64cab31e3678b.jpg'),
(5, 5, '64cab32cd504e.jpg'),
(6, 6, '64cab33410078.jpg'),
(7, 7, '64cab39db2624.png'),
(8, 8, '64cab3d8be4d7.jpg');
...
--
-- Table structure for table `tb_admin.properties`
--

CREATE TABLE `tb_admin.properties` (
  `id` int(11) NOT NULL,
  `enterp_id` int(11) NOT NULL,
  `name` varchar(255) NOT NULL,
...
--
-- Dumping data for table `tb_admin.properties`
--

INSERT INTO `tb_admin.properties` (`id`, `enterp_id`, `name`, `price`, `area`, `order_id`) VALUES
(4, 5, 'Room 103', 11.24, 500, 0),
(7, 5, 'Room 506', 5.42, 1200, 0),
(8, 5, 'Room 90', 1.23, 1200, 0);
...
(3, 'CybertimeUP Banner', 'Banner of the CybertimeUP', 10, 10, 10, 10, 14),
(5, 'New Product', 'now', 55, 80, 85, 110, 855);
...
--
-- Indexes for table `tb_admin.enterprises`
--
...
--
-- Indexes for table `tb_admin.images_properties`
--
ALTER TABLE `tb_admin.images_properties`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `tb_admin.properties`
--
ALTER TABLE `tb_admin.properties`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `tb_admin.enterprises`
--
ALTER TABLE `tb_admin.enterprises`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
-- AUTO_INCREMENT for table `tb_admin.images_properties`
--
ALTER TABLE `tb_admin.images_properties`
...
--
-- AUTO_INCREMENT for table `tb_admin.properties`
--
ALTER TABLE `tb_admin.properties`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
