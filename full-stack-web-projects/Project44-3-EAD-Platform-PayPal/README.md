<h1 align="center">
    ...
    <br>
    EAD Platform Advanced Prototype - PayPal 
</h1>

<h4 align="center">
 EAD Platform Advanced Prototype - PayPal is a repository of the project involving web 2.0 and front-end that every programmer in the world should know:
...
4.4- Configure the gateway payment - PayPal(file on project):

<br/>

[Gateway Documentation for Testing - PayPal](https://developer.paypal.com)
