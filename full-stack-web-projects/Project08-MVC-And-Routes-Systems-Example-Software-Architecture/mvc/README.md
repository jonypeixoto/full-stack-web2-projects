<h1 align="center">
    <img alt="Full-Stack GitHub README" src="https://github.com/jonypeixoto/jonypeixoto/blob/main/assets/mvcroutesystems-model.gif" />
    <br>
    MVC and Routes Systems: Example Model Software Architecture
</h1>

<h4 align="center">
 MVC and Routes Systems: Example Model Software Architecture is a repository of the project involving web 2.0 and front-end that every programmer in the world should know:
...
![App Screenshot](https://github.com/jonypeixoto/jonypeixoto/blob/main/assets/GIF-mvcroutesystems-model.gif)<br/>
...
- [JavaScript](https://developer.mozilla.org/pt-BR/docs/Web/JavaScript)
- [PHP](https://www.php.net/docs.php)
- [PHP Sandbox](https://www.postman.com/supply-geoscientist-17686853/workspace/php-sandbox/overview)
- [Bootstrap](https://getbootstrap.com/)
