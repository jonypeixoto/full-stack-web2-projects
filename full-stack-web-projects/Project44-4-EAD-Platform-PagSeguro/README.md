<h1 align="center">
    ...
    <br>
    EAD Platform Advanced Prototype - PagSeguro 
</h1>

<h4 align="center">
 EAD Platform Advanced Prototype - PagSeguro is a repository of the project involving web 2.0 and front-end that every programmer in the world should know:
...
4.4- Configure the gateway payment - PagSeguro(file on project):

<br/>

[Documentation of the gateway payment on PagSeguro](https://dev.pagbank.uol.com.br/)
