<h1 align="center">
    <img alt="Front-End GitHub README" src="https://github.com/jonypeixoto/jonypeixoto/blob/main/assets/curl-and-creating-webservice.gif" />
    <br>
    Web Services and API: cURL and creating webservice(REST or RESTful)
</h1>

<h4 align="center">
   Web Services and API: cURL and creating webservice(REST or RESTful) is a repository of the project involving web 2.0 and front-end that every programmer in the world should know:
...
![App Screenshot](https://github.com/jonypeixoto/jonypeixoto/blob/main/assets/GIF-curl-and-creating-webservice.gif)
