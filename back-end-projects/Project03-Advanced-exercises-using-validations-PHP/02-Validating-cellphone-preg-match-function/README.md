<h1 align="center">
    <img alt="Front-End GitHub README" src="https://github.com/jonypeixoto/jonypeixoto/blob/main/assets/validatingphonenumber.gif" />
    <br>
    Validating phone number using PHP
</h1>

<h4 align="center">
  Validating full name using PHP is a repository of the project involving web 2.0 and front-end that every programmer in the world should know:
...
![App Screenshot](https://github.com/jonypeixoto/jonypeixoto/blob/main/assets/GIF-validatingphonenumber.gif)
