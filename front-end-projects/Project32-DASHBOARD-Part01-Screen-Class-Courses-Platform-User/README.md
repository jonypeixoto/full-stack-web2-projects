<h1 align="center">
    <img alt="Front-End GitHub README" src="https://github.com/jonypeixoto/jonypeixoto/blob/main/assets/dashboard-part01-screen-class-courses-platform-user.gif" />
    <br>
    Dashboard Part01 Screen Class Courses Platform User
</h1>

<h4 align="center">
    Dashboard Part01 Screen Class Courses Platform User is a repository of the project involving web 2.0 and front-end that every programmer in the world should know:
...
![App Screenshot](https://github.com/jonypeixoto/jonypeixoto/blob/main/assets/GIF-dashboard-part01-screen-class-courses-platform-user.gif)

<p align="center">
  <a href="https://dashboardpart01-screenclasscourses.netlify.app" target="_blank">
