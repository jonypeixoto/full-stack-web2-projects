<h1 align="center">
    <img alt="Front-End GitHub README" src="https://github.com/jonypeixoto/jonypeixoto/blob/main/assets/dashboard-part02-login-user-platform.gif" />
    <br>
    Dashboard Part02 Login User Platform
</h1>

<h4 align="center">
    Dashboard Part02 Login User Platform is a repository of the project involving web 2.0 and front-end that every programmer in the world should know:
...
![App Screenshot](https://github.com/jonypeixoto/jonypeixoto/blob/main/assets/GIF-dashboard-part02-login-user-platform.gif)

<p align="center">
  <a href="https://dashboardpart02-loginuserplatform.netlify.app" target="_blank">
