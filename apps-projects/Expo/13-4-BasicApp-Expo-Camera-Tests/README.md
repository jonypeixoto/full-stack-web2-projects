<h1 align="center">
    <img alt="Front-End GitHub README" src="https://github.com/jonypeixoto/jonypeixoto/blob/main/assets/expocameratests-basicapp.gif" />
    <br>
    Basic App: Expo Camera Tests App
</h1>

<h4 align="center">
 Basic App: Expo Camera Tests App is a repository of the project involving web 2.0 and front-end that every programmer in the world should know:
...
![App Screenshot](https://github.com/jonypeixoto/jonypeixoto/blob/main/assets/photo1-expocameratests-basicapp.jpg)<br/>

<br/>

![App Screenshot](https://github.com/jonypeixoto/jonypeixoto/blob/main/assets/photo2-expocameratests-basicapp.jpg)

<br/>

![App Screenshot](https://github.com/jonypeixoto/jonypeixoto/blob/main/assets/photo3-expocameratests-basicapp.jpg)
...
1) Download and install [NodeJS](https://nodejs.org/en) and NPM(package manager for Node.JS npm)

</br>

To verify that [NodeJS](https://nodejs.org/en) and [NodeJS](https://nodejs.org/en) NPM are installed, type:
...
2) Download and install [Expo](https://docs.expo.dev/archive/expo-cli/) with the command - check the documentation if you get any errors:

npm install -g expo-cli

<br/>

3) To verify the installation of Expo, type:

<br/>

expo --version

4) To launch the Expo application, navigate to the directory in your command prompt and type:
...
Then an Expo web server will open automatically on a localhost Expo server
...
3- Download and install the [Firebase](https://firebase.google.com) using the command:
...
- [Animation using React Native/Expo](https://reactnative.dev/docs/animated?redirected)
- [Visual Studio Code](https://code.visualstudio.com/)
- [Responsive Design](https://developers.google.com/search/mobile-sites/mobile-seo/responsive-design)
- [UX/UI](https://www.adobe.com/br/creativecloud/ui-ux.html)
- [Adobe XD](https://www.adobe.com/br/products/xd.html)
