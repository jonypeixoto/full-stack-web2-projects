<h1 align="center">
    <img alt="Front-End GitHub README" src="https://github.com/jonypeixoto/jonypeixoto/blob/main/assets/whatsappcloneapp.gif" />
    <br>
    WhatsApp Clone App
</h1>

<h4 align="center">
 WhatsApp Clone App is a repository of the project involving web 2.0 and front-end that every programmer in the world should know:
...
![App Screenshot](https://github.com/jonypeixoto/jonypeixoto/blob/main/assets/GIF-whatsappcloneapp.gif)<br/>
...
[Testing all the depedencies on App](https://reactnavigation.org/docs/tab-based-navigation/) using minimal example of tab-based navigation
